...
namespace _02._Corruption_Checksum
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Part 1: Difference between highest and lowest intiger in line
            for (int i = 0; i < arrayLength; i++)
            {
                // Looking for highest value in every line
                ...
                Console.Write(i + ". Max = " + max);

                // Looking for lowest value in every line
            ...
            Console.WriteLine("Checksum 1: " + checksum);


            // Part 2: Sum of evenly divisible values in each line
            ...
            Console.WriteLine("Checksum 2: " + checksum);
        }
    }
} 
